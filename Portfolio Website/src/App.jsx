...
function App() {
  return (
    <>
      <div>
        <Helmet>
          <title>Manav Lade | Software Developer Portfolio</title>
          <meta
            name="description"
            content="Explore the portfolio of Manav Lade, a software Developer with hands on experience in Full Stack Development, skilled in React.js, Next.js, Node.js, MongoDB, and more. Discover scalable web applications, innovative projects, and professional experience in software development."
          />
          <meta name="keywords" content="Manav Lade, Full Stack Developer, React.js, Next.js, Node.js, MERN Stack, Portfolio, Software Developer, Scalable Web Applications, MongoDB, Frontend Development, Backend Development, Cloud Engineer, Manav Lade Portfolio, Manav Lade Full Stack Developer Portfolio, Manav Lade Software Developer Portfolio" />
